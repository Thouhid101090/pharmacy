...
<div class="container mt-3">
    ...
    <form action="{{ route('stocks.search') }}" method="GET" class="mb-4">
        <div class="input-group shadow-sm">
            <input type="text" name="query" class="form-control" placeholder="Search medicine name..." aria-label="Search">
        ...
        <div class="table-responsive d-none d-md-block">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="text-center py-4 text-muted">No stock items found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
